...
-- ----------------------------
INSERT INTO "db_flow"."act_ge_property"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_evt_log"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_hi_detail"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_hi_identitylink"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_hi_procinst"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_hi_taskinst"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_hi_varinst"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_procdef_info"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_re_deployment"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_deadletter_job"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_event_subscr"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_execution"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_identitylink"
    ADD CONSTRAINT "act_ru_identitylink_pkey" PRIMARY KEY ("id_");

-- ----------------------------
-- Primary Key structure for table act_ru_integration
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_integration"
    ADD CONSTRAINT "act_ru_integration_pkey" PRIMARY KEY ("id_");
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_job"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_suspended_job"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_task"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_timer_job"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_variable"
...
-- ----------------------------
ALTER TABLE "db_flow"."act_ge_bytearray"
    ADD CONSTRAINT "act_fk_bytearr_depl" FOREIGN KEY ("deployment_id_") REFERENCES "db_flow"."act_re_deployment" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_procdef_info
-- ----------------------------
ALTER TABLE "db_flow"."act_procdef_info"
    ADD CONSTRAINT "act_fk_info_json_ba" FOREIGN KEY ("info_json_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_procdef_info"
    ADD CONSTRAINT "act_fk_info_procdef" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_re_model
-- ----------------------------
ALTER TABLE "db_flow"."act_re_model"
    ADD CONSTRAINT "act_fk_model_deployment" FOREIGN KEY ("deployment_id_") REFERENCES "db_flow"."act_re_deployment" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_re_model"
    ADD CONSTRAINT "act_fk_model_source" FOREIGN KEY ("editor_source_value_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_re_model"
    ADD CONSTRAINT "act_fk_model_source_extra" FOREIGN KEY ("editor_source_extra_value_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_deadletter_job
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_deadletter_job"
    ADD CONSTRAINT "act_fk_deadletter_job_exception" FOREIGN KEY ("exception_stack_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_deadletter_job"
    ADD CONSTRAINT "act_fk_deadletter_job_execution" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_deadletter_job"
    ADD CONSTRAINT "act_fk_deadletter_job_proc_def" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_deadletter_job"
    ADD CONSTRAINT "act_fk_deadletter_job_process_instance" FOREIGN KEY ("process_instance_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_event_subscr
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_event_subscr"
    ADD CONSTRAINT "act_fk_event_exec" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_execution
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_execution"
    ADD CONSTRAINT "act_fk_exe_parent" FOREIGN KEY ("parent_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_execution"
    ADD CONSTRAINT "act_fk_exe_procdef" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_execution"
    ADD CONSTRAINT "act_fk_exe_procinst" FOREIGN KEY ("proc_inst_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_execution"
    ADD CONSTRAINT "act_fk_exe_super" FOREIGN KEY ("super_exec_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_identitylink
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_identitylink"
    ADD CONSTRAINT "act_fk_athrz_procedef" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_identitylink"
    ADD CONSTRAINT "act_fk_idl_procinst" FOREIGN KEY ("proc_inst_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_identitylink"
    ADD CONSTRAINT "act_fk_tskass_task" FOREIGN KEY ("task_id_") REFERENCES "db_flow"."act_ru_task" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_integration
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_integration"
    ADD CONSTRAINT "act_fk_int_execution" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_integration"
    ADD CONSTRAINT "act_fk_int_proc_def" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_integration"
    ADD CONSTRAINT "act_fk_int_proc_inst" FOREIGN KEY ("process_instance_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_job
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_job"
    ADD CONSTRAINT "act_fk_job_exception" FOREIGN KEY ("exception_stack_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_job"
    ADD CONSTRAINT "act_fk_job_execution" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_job"
    ADD CONSTRAINT "act_fk_job_proc_def" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_job"
    ADD CONSTRAINT "act_fk_job_process_instance" FOREIGN KEY ("process_instance_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_suspended_job
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_suspended_job"
    ADD CONSTRAINT "act_fk_suspended_job_exception" FOREIGN KEY ("exception_stack_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_suspended_job"
    ADD CONSTRAINT "act_fk_suspended_job_execution" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_suspended_job"
    ADD CONSTRAINT "act_fk_suspended_job_proc_def" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_suspended_job"
    ADD CONSTRAINT "act_fk_suspended_job_process_instance" FOREIGN KEY ("process_instance_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_task
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_task"
    ADD CONSTRAINT "act_fk_task_exe" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_task"
    ADD CONSTRAINT "act_fk_task_procdef" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_task"
    ADD CONSTRAINT "act_fk_task_procinst" FOREIGN KEY ("proc_inst_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_timer_job
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_timer_job"
    ADD CONSTRAINT "act_fk_timer_job_exception" FOREIGN KEY ("exception_stack_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_timer_job"
    ADD CONSTRAINT "act_fk_timer_job_execution" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_timer_job"
    ADD CONSTRAINT "act_fk_timer_job_proc_def" FOREIGN KEY ("proc_def_id_") REFERENCES "db_flow"."act_re_procdef" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_timer_job"
    ADD CONSTRAINT "act_fk_timer_job_process_instance" FOREIGN KEY ("process_instance_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table act_ru_variable
-- ----------------------------
ALTER TABLE "db_flow"."act_ru_variable"
    ADD CONSTRAINT "act_fk_var_bytearray" FOREIGN KEY ("bytearray_id_") REFERENCES "db_flow"."act_ge_bytearray" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_variable"
    ADD CONSTRAINT "act_fk_var_exe" FOREIGN KEY ("execution_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "db_flow"."act_ru_variable"
    ADD CONSTRAINT "act_fk_var_procinst" FOREIGN KEY ("proc_inst_id_") REFERENCES "db_flow"."act_ru_execution" ("id_") ON DELETE NO ACTION ON UPDATE NO ACTION;
