...
mybatis-plus:
  ...
  global-config:
    ...
    db-config:
      ...
      logic-delete-value: true', '918cbce62113fc86a824a8b197ed3f90', '2023-04-17 00:34:51.071',
        '2023-04-17 00:34:51.071', NULL, '192.168.31.6', '', '', NULL, NULL, NULL, 'yaml', NULL, '');
INSERT INTO "db_nacos"."config_info"
...
logging:
  ...
  group:
    yangxj96:
      ...
      - io.github.yangxj96.starter.security.autoconfigure', 'c38b8272369ffff4561b4f7de1cef972',
        '2023-04-17 00:32:01.158', '2023-04-17 00:42:43.427', 'nacos', '192.168.31.6', '', '', '', '', '', 'yaml', '',
        '');
...
VALUES (0, 5, 'yangxj96-saas-common.yml', 'DEFAULT_GROUP', '', '# 端点检查放开所有
management:
  endpoints:
    web:
      exposure:
...
logging:
  ...
  group:
    yangxj96:
      ...
      - io.github.yangxj96.starter.db.autoconfigure
      - io.github.yangxj96.starter.remote.autoconfigure
      - io.github.yangxj96.starter.security.autoconfigure', 'ee66aa31cdcdf33cb535e95c905fe036', '2010-05-05 00:00:00',
        '2023-04-17 00:32:01.158', NULL, '192.168.31.6', 'I         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (0, 6, 'yangxj96-saas-wsl.yml', 'DEFAULT_GROUP', '', 'yangxj96:
  wsl: 192.168.31.100', 'febacd3a4578427169e05cc0b7734b28', '2010-05-05 00:00:00', '2023-04-17 00:33:45.184', NULL,
        '192.168.31.6', 'I         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (4, 7, 'yangxj96-saas-wsl.yml', 'DEFAULT_GROUP', '', 'yangxj96:
  wsl: 192.168.31.100', 'febacd3a4578427169e05cc0b7734b28', '2010-05-05 00:00:00', '2023-04-17 00:33:56.899', NULL,
        '192.168.31.6', 'D         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (0, 8, 'yangxj96-saas-datasource.yml', 'DEFAULT_GROUP', '', 'spring:
  datasource:
    username: postgres
    password: QuVsKppcWvwwX2Vv
    driver-class-name: org.postgresql.Driver
...
mybatis-plus:
  ...
  global-config:
    ...
    db-config:
      ...
      logic-delete-field: deleted
      logic-not-delete-value: false
      logic-delete-value: true', '918cbce62113fc86a824a8b197ed3f90', '2010-05-05 00:00:00', '2023-04-17 00:34:51.071',
        NULL, '192.168.31.6', 'I         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (3, 9, 'yangxj96-saas-common.yml', 'DEFAULT_GROUP', '', '# 端点检查放开所有
management:
  endpoints:
    web:
      exposure:
...
logging:
  ...
  group:
    yangxj96:
      ...
      - io.github.yangxj96.starter.remote.autoconfigure
      - io.github.yangxj96.starter.security.autoconfigure', 'ee66aa31cdcdf33cb535e95c905fe036', '2010-05-05 00:00:00',
        '2023-04-17 00:37:00.632', 'nacos', '192.168.31.6', 'U         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (3, 10, 'yangxj96-saas-common.yml', 'DEFAULT_GROUP', '', 'server:
  port: 0
...
logging:
  ...
  group:
    yangxj96:
      ...
      - io.github.yangxj96.starter.db.autoconfigure
      - io.github.yangxj96.starter.remote.autoconfigure
      - io.github.yangxj96.starter.security.autoconfigure', 'c1d9c3e3d10a2de5044232f0fef34db2', '2010-05-05 00:00:00',
        '2023-04-17 00:38:25.651', 'nacos', '192.168.31.6', 'U         ', '', '');
INSERT INTO "db_nacos"."his_config_info"
VALUES (3, 11, 'yangxj96-saas-common.yml', 'DEFAULT_GROUP', '', '# 端点检查放开所有
management:
  endpoints:
    web:
      exposure:
...
logging:
  ...
  group:
    yangxj96:
      ...
      - io.github.yangxj96.starter.db.autoconfigure
      - io.github.yangxj96.starter.remote.autoconfigure
      - io.github.yangxj96.starter.security.autoconfigure', '72cd167b59ba7ccba1887911ccfce9c8', '2010-05-05 00:00:00',
        '2023-04-17 00:42:43.427', 'nacos', '192.168.31.6', 'U         ', '', '');
...
CREATE INDEX "idx_gmt_create" ON "db_nacos"."his_config_info" USING btree (
                                                                           "gmt_create" "pg_catalog"."timestamp_ops" ASC
                                                                           NULLS LAST
    );
CREATE INDEX "idx_gmt_modified" ON "db_nacos"."his_config_info" USING btree (
                                                                             "gmt_modified" "pg_catalog"."timestamp_ops"
                                                                             ASC NULLS LAST
    );
