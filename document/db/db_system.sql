...
VALUES (1628283509519011841, 'sys.fileload.type', 'file', 0, '2023-02-22 14:40:15.372752', 1600691095698763778, '2023-02-22 14:43:37.511645', 'f');
...
VALUES (1603273714231717890, 'xxxxx', '分组1', 't', 'f', 2, NULL, 0, '2022-12-15 14:20:15.516919', NULL, '2022-12-15 14:32:58.73625', 't');
INSERT INTO "db_system"."t_dictionaries"
VALUES (1603276627540729857, '0aafb3ccd124408daf2d5b31dc5f310c', '分组1', 't', 'f', 2, NULL, 0, '2022-12-15 14:31:50.104166', NULL, '2022-12-15 14:33:42.175229', 't');
INSERT INTO "db_system"."t_dictionaries"
VALUES (1603276811024752641, 'BE7836CB8FB244AAA6E0C1910464243D', '分组1-修改2', 't', 'f', 1, 0, 0, '2022-12-15 14:32:33.849562', NULL, '2022-12-15 14:36:22.601956', 'f');
...
VALUES (1606320786226655234, 'lb://yangxj96-serve-system', 0, '[
  ...
  "key1": "v1",
  "key2": "v2"
}', 0, '2022-12-24 00:08:14.091501', NULL, 'f', 'yangxj96-serve-system', '2022-12-24 02:46:19.500485');
INSERT INTO "db_system"."t_sys_route"
VALUES (1606321053034721282, 'lb://yangxj96-serve-auth', 0, '[
  ...
  "key1": "v1",
  "key2": "v2"
}', 0, '2022-12-24 00:09:17.704698', NULL, 'f', 'yangxj96-serve-auth', '2022-12-24 02:46:30.127621');
INSERT INTO "db_system"."t_sys_route"
VALUES (1606321142734106626, 'lb://yangxj96-serve-dept', 0, '[
  ...
  "key1": "v1",
  "key2": "v2"
}', 0, '2022-12-24 00:09:39.097851', NULL, 'f', 'yangxj96-serve-dept', '2022-12-24 02:46:24.632602');

-- ----------------------------
-- Primary Key structure for table t_configure
-- ----------------------------
ALTER TABLE "db_system"."t_configure"
    ADD CONSTRAINT "t_configure_pkey" PRIMARY KEY ("id");
